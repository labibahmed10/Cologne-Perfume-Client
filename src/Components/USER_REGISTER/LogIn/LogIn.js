...
const LogIn = () => {
  ...
  if (user) {
    axios
      .post("https://cologne-perfume-server.vercel.app/createToken", {
      ...
      <div className="md:w-full">
        <div className="md:px-16 px-3 py-8 border bg-[#EEEEF0] text-[#3D3D3D]">
          ...
          <form action="" onSubmit={handleSubmitSignIn}>
            ...
            <input type="submit" value="Login" className="w-full my-3 py-3 bg-[#ad6449] text-lg font-semibold text-[aliceblue] cursor-pointer" />
